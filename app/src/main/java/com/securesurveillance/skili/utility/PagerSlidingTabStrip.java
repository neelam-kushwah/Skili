...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabPaddingTop = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mTabPaddingTop, dm);

        mDividerWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mDividerWidth, dm);
        mTabTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mTabTextSize, dm);
        ...
        mTabSelectColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTabSelectColor, mTabSelectColor);
        mTabUnselectColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTabUnSelectColor, mTabUnselectColor);
        ...
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabPaddingTopBottom, mTabPaddingTop);

        mTabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsTabBackground, mTabBackgroundResId);
        mTabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabTextSize, 0);
...
//        mTabTextTypeface = Typeface.create(tabTextTypefaceName, mTabTextTypefaceStyle);
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            v.setPadding(mTabPadding, mTabPaddingTop, mTabPadding, mTabPaddingTop);
            TextView tab_title = (TextView) v.findViewById(R.id.psts_tab_title);
            if (tab_title != null) {
                tab_title.setTextColor(mTabUnselectColor);
    ...
    private void unSelect(View tab) {
        if (tab != null) {
            ...
            if (tab_title != null) {
                ...
                //  tab_title.setTextColor(Color.parseColor("#808080"));
                tab_title.setTextColor(mTabUnselectColor);

                // tab_title.setTypeface(mTabTextTypeface, Typeface.NORMAL);
    ...
    private void select(View tab) {
        if (tab != null) {
            ...
            if (tab_title != null) {
                ...
                // tab_title.setTextColor(Color.parseColor("#e9212d"));
                tab_title.setTextColor(mTabSelectColor);

                // tab_title.setTypeface(mTabTextTypeface, Typeface.BOLD);
            }
