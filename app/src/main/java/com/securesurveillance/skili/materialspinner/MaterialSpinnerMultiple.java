...
package com.securesurveillance.skili.materialspinner;
 ...
 */
public class MaterialSpinnerMultiple extends AppCompatTextView {

    private OnNothingSelectedListener onNothingSelectedListener;
    private OnItemSelectedListener onItemSelectedListener;
    private MaterialSpinnerBaseAdapterMultiple adapter;
    ...
    public MaterialSpinnerMultiple(Context context) {
        super(context);
        init(context, null);
    }

    public MaterialSpinnerMultiple(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MaterialSpinnerMultiple(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }
public MaterialSpinnerBaseAdapterMultiple getAdapter(){
        return  adapter;
}
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            backgroundColor = ta.getColor(R.styleable.MaterialSpinner_ms_background_color, defaultColor);
            backgroundDrawable = ta.getDrawable(R.styleable.MaterialSpinner_ms_background_drawable);
...
//                }
                ...
                adapter.notifyItemSelectedArr(position);
               ...
               // collapse();
                if (onItemSelectedListener != null) {
                    ...
                    onItemSelectedListener.onItemSelected(MaterialSpinnerMultiple.this, position, id, item, adapter.getSelectedIndexArray());
                }
            }
        });
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                if (nothingSelected && onNothingSelectedListener != null) {
                    onNothingSelectedListener.onNothingSelected(MaterialSpinnerMultiple.this);
                }
                if (!hideArrow) {
                    animateArrow(false);
                }
    ...
    public void setBackgroundColor(int color) {
        ...
        if (background instanceof StateListDrawable) { // pre-L
            try {
                ...
                Log.e("MaterialSpinnerMultiple", "Error setting background color", e);
            }
...
//    popupWindow.getBackground().setColorFilter(color, PorterDuff.Mode.SRC_IN);
        popupWindow.getBackground().setColorFilter(color, PorterDuff.Mode.SRC_IN);
        //listView.setBackgroundDrawable(backgroundDrawable);
    ...
    public void onRestoreInstanceState(Parcelable savedState) {
        if (savedState instanceof Bundle) {
            ...
            if (adapter != null) {
                ...
                adapter.notifyItemSelectedArr(selectedIndex);
    ...
    public <T> void setItems(@NonNull List<T> items) {
        adapter = new MaterialSpinnerAdapterMultiple(getContext(), items).setBackgroundSelector(backgroundSelector)
                .setTextColor(textColor);
    ...
    public void setAdapter(@NonNull ListAdapter adapter) {
        this.adapter = new MaterialSpinnerAdapterWrapperMultiple(getContext(), adapter).setBackgroundSelector(backgroundSelector)
                .setTextColor(textColor);
     ...
     * @param <T>     The type
     */
    public <T> void setAdapter(MaterialSpinnerAdapterMultiple<T> adapter) {
    ...
    private void setAdapterInternal(@NonNull MaterialSpinnerBaseAdapterMultiple adapter) {
...
//        return (int) listViewHeight;
    ...
    public interface OnItemSelectedListener<T> {
         ...
         */
        void onItemSelected(MaterialSpinnerMultiple view, int position, long id, T item, ArrayList<Integer> arrSelectedSubCategory);
    }
    ...
    public interface OnNothingSelectedListener {
         ...
         */
        void onNothingSelected(MaterialSpinnerMultiple spinner);
    }
}
