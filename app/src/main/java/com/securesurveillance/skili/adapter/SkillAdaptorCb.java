...
public class SkillAdaptorCb extends BaseAdapter {
    ...
    public SkillAdaptorCb(Context context, ArrayList<SkillModel.InnerSkillModel> arrModel, ArrayList<Integer> checkedPosition) {
