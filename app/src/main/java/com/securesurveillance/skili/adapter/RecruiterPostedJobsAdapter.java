...
public class RecruiterPostedJobsAdapter extends RecyclerView.Adapter<RecruiterPostedJobsAdapter.MyViewHolder> {
    ...
    public RecruiterPostedJobsAdapter(Context context, List<GetAllJobRecruiterDetailModel> data, SharePreferanceWrapperSingleton objSPS, int isFavourite) {
